...
<header class="py-4 shadow-sm bg-white">
    ...
    <div class="container py-4 flex items-center gap-3">
        ...
        <a href="register" class="text-gray-600 font-medium">Register</a>
    </div>
...
<p class="text-sm mt-4">Enter Your Details Below
</p>
<form action="" class="flex flex-col space-y-2 gap-4">
<input class="p-2  rounded-xl border w-full" type="text" name="Name" placeholder="Name">
<input class="p-2 mt-8 rounded-xl border" type="text" name="email" placeholder="Email or phone number">
<div class="relative">
  ...
  <button class="bg-[#0E86D4] py-2 hover:scale-105 duration-300">Create Account</button>
</form>
...
<p class="mt-3 text-xs border-b border-gray-400 py-4"> Already have account<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
  <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 13.5 12 21m0 0-7.5-7.5M12 21V3" />
</svg>
</p>
<div class="mt-3 text-sm flex justify-between items-center">
  <a href="login" class="py-2 px-5  border rounded-xl bg-[#0E86D4]">Login</a>
</div>
</div>
