...
<header class="py-4 shadow-sm bg-white">
    ...
    <div class="container py-4 flex items-center gap-3">
        ...
        <a href="profileinfo" class="text-gray-600 font-medium">Profile Info</a>
    </div>
        ...
        <div class="space-y-4">
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" class="block w-full border border-gray-300 px-4 py-3 text-gray-600 text-sm rounded placeholder-gray-400 focus:border-pink-400 focus:ring-0" placeholder="Enter first name">
                </div>
                <div>
                    <label for=""class="text-gray-600 mb-2 block">Last name</label>
                    <input type="text" class="block w-full border border-gray-300 px-4 py-3 text-gray-600 text-sm rounded placeholder-gray-400 focus:border-pink-400 focus:ring-0" placeholder="Enter last name">
                </div>
            </div>
            <div class="grid grid-cols-2 gap-4">
                <div>
                    <label for="" class="text-gray-600 mb-2 block">Birthday</label>
                    <input type="date" class="block w-full border border-gray-300 px-4 py-3 text-gray-600 text-sm rounded placeholder-gray-400 focus:border-pink-400 focus:ring-0 ">
                </div>
                <div>
                    <label for=""class="text-gray-600 mb-2 block">Gender</label>
                    <select class="block w-full border border-gray-300 px-4 py-3 text-gray-600 text-sm rounded placeholder-gray-400 focus:border-pink-400 focus:ring-0 ">
                        <option >Male</option>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="email" class="block w-full border border-gray-300 px-4 py-3 text-gray-600 text-sm rounded placeholder-gray-400 focus:border-pink-400 focus:ring-0" placeholder="Enter Email Address">
                </div>
                <div>
                    <label for=""class="text-gray-600 mb-2 block">Phone number</label>
                    <input type="text" class="block w-full border border-gray-300 px-4 py-3 text-gray-600 text-sm rounded placeholder-gray-400 focus:border-pink-400 focus:ring-0" placeholder="Enter Phone number">
                </div>
            </div>
            <div class="mt-4">
                <button type="submit" class="text-center  bg-pink-400 border border-pink-500 text-white px-4 py-3 rounded-md hover:bg-transparent hover:text-pink-400 transition">Save Changes</button>
            </div>
